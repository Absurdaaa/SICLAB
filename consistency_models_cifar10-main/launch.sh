...
python -m jcm.main --config configs/cifar10_ve_cd.py --workdir /tangwenhao/lhp/SICLAB/consistency_models_cifar10-main/outputs/cd-lpips-rerun --mode train --config.optim.lr=0.0004 --config.training.loss_norm='lpips'
